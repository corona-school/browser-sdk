...
export declare function startDeflateWorker(configuration: RumConfiguration, onInitializationFailure: () => void, createDeflateWorkerImpl?: typeof createDeflateWorker): DeflateWorker | undefined;
 ...
 */
export declare function doStartDeflateWorker(configuration: RumConfiguration, createDeflateWorkerImpl?: typeof createDeflateWorker): void;
export {};
